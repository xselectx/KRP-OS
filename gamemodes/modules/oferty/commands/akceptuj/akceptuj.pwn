...
YCMD:akceptuj(playerid, params[], help)
{
    ...
    if(sscanf(params, "s[32]", nazwa))
    {
        ...
        SendClientMessage(playerid, COLOR_GREY, "Dostêpne nazwy: Produkt, Zaproszenie, Zastrzyk, Mandat, Tuning");
        SendClientMessage(playerid, COLOR_GREY, "Dostêpne nazwy: Smierc, Tatuaz");
