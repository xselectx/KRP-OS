...
MRP_ShowAnim(playerid)
{
	...
	ShowPlayerDialogEx(playerid, D_ANIMLIST, 2, "{4876FF}Kotnik Role Play » {FFFFFF}Animacje", dialog, "Wybierz", "WyjdŸ");
	return 1;
}
...
MRP_DoAnimation(playerid, arg1[])
{
	...
	{
		SendClientMessage(playerid, -1, "Ta animacja zosta³a wy³¹czzona na czas tworzenia systemu przedmiotów!");
		return 1;
	}
