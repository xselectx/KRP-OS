		...
		if(GroupPlayerDutyRank(playerid) >= 3)
		{
			if(owyscig[playerid] != 666)
			{
				...
				if(ProxDetectorS(10.0, playerid, playa))
				{
					...
					format(string, sizeof(string), "Przydzieli³eœ %s udzia³ w wyœcigu. Aby rozpocz¹æ wyœcig, poproœ zawodników o ustawienie siê na mecie i wpisz /wyscig_start.", giveplayer);
