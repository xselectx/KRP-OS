...
YCMD:patrol(playerid, params[], help)
{
    ...
    if(sscanf(params, "s[32]S()[32]", var, sign)) return sendTipMessageEx(playerid, COLOR_GRAD2, "Dostêpne parametry: start, stop, mapa, akceptuj, lista, vsign");
    ...
    else if(strcmp(var, "vsign", true) == 0)
    {
        ...
        if(IsPlayerInAnyVehicle(playerid))
        {
            ...
            if(!IsACopCar(carid))
                return sendErrorMessage(playerid, "Musisz byæ w pojeŸdzie policyjnym.");
