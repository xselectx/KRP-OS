...
YCMD:ann(playerid, params[], help)
{
	if(PlayerInfo[playerid][pAdmin] > 5)
	{
		...
		else if(OnDuty[playerid] > 0 || OnDutyCD[playerid] == 1) return sendErrorMessage(playerid, "Jesteœ na s³u¿bie IC, graj IC!"); 
        ...
        Log(adminLog, WARNING, "Admin %s u¿y³ /ann o treœci: %s", GetPlayerLogName(playerid), params);
	}
	else
	{
