				...
				else
				{
				    if(PlayerInfo[playerid][pNewAP] >= 1 && PlayerInfo[playerid][pNewAP] <= 3)
				    {
						...
						if(AddPunishment(giveplayerid, GetNick(giveplayerid), playerid, gettime(), PENALTY_BAN, 0, result, 0) == 1) {
							...
							SendClientMessage(giveplayerid, COLOR_NEWS, "Jeœli uwa¿asz ze ban jest nies³uszny wejdŸ na kotnik-rp.pl i z³ó¿ prosbê o UN-BAN");
							Log(punishmentLog, WARNING, "Pó³Admin %s ukara³ %s kar¹ bana, powód: %s", 
