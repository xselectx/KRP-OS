		...
		if (PlayerInfo[playerid][pAdmin] >= 5000 || PlayerInfo[playerid][pNewAP] == 4)
		{
        	...
        	if(IsPlayerConnected(giveplayerid))
        	{
            	if(giveplayerid != INVALID_PLAYER_ID)
            	{
	                ...
	                Log(punishmentLog, WARNING, "Admin %s ukara³ %s kar¹ cichego blocka, powód: %s", 
						GetPlayerLogName(playerid),
						GetPlayerLogName(giveplayerid),
						result);
		            PlayerInfo[playerid][pBlock] = 1;
					SendClientMessage(giveplayerid, COLOR_NEWS, "Twoje konto zosta³o zablokowane za z³y nick. Jeœli block jest nies³uszny wejdŸ na kotnik-rp.pl i napisz proœbê o UN BLOCK");
					KickEx(giveplayerid);
