...
YCMD:kostka(playerid, params[], help)
{
    ...
    if(strcmp(params, "akceptuj", true) == 0 || strcmp(params, "a", true) == 0)
    {
        ...
        Log(casinoLog, WARNING, "%s zaakceptowa³ ofertê kostki od %s", GetPlayerLogName(playerid), GetPlayerLogName(id));
    }
    else if(strcmp(params, "odrzuæ", true) == 0 || strcmp(params, "odrzuc", true) == 0 || strcmp(params, "o", true) == 0)
    {
        ...
        Log(casinoLog, WARNING, "%s odrzuci³ ofertê kostki od %s", GetPlayerLogName(playerid), GetPlayerLogName(id));
    }
    ...
    else
    {
        ...
        if(kasa < PRICE_KOSTKA_MIN || kasa > PRICE_KOSTKA_MAX) return sendTipMessageEx(playerid, COLOR_PAPAYAWHIP, "Stawka nie mniejsza ni¿ "#PRICE_KOSTKA_MIN"$ i nie wiêksza ni¿ "#PRICE_KOSTKA_MAX"$");
        ...
        Log(casinoLog, WARNING, "%s oferuje kostkê graczowi %s.", GetPlayerLogName(playerid), GetPlayerLogName(id));
        sendTipMessageEx(id, COLOR_GREEN, str);
...
public kolofortuny(playerid)
{
    ...
    {
        wygrana = 1;
        Log(payLog, WARNING, "%s zakrêci³ ko³em fortuny i wypad³o: 1$", GetPlayerLogName(playerid));
        format(string, sizeof(string), "* %s zakrêci³ ko³em fortuny które zatrzyma³o siê na: 1$", GetNick(playerid));
        ProxDetector(5.0, playerid, string, TEAM_GREEN_COLOR,TEAM_GREEN_COLOR,TEAM_GREEN_COLOR,TEAM_GREEN_COLOR,TEAM_GREEN_COLOR);
    }
    else if(kolo > 30 && kolo <= 45)//2
    {
        wygrana = 2;
        Log(payLog, WARNING, "%s zakrêci³ ko³em fortuny i wypad³o: 2$", GetPlayerLogName(playerid));
        format(string, sizeof(string), "* %s zakrêci³ ko³em fortuny które zatrzyma³o siê na: 2$", GetNick(playerid));
        ProxDetector(5.0, playerid, string, TEAM_GREEN_COLOR,TEAM_GREEN_COLOR,TEAM_GREEN_COLOR,TEAM_GREEN_COLOR,TEAM_GREEN_COLOR);
    }
    else if(kolo > 45 && kolo <= 53)//5
    {
        wygrana = 5;
        Log(payLog, WARNING, "%s zakrêci³ ko³em fortuny i wypad³o: 5$", GetPlayerLogName(playerid));
        format(string, sizeof(string), "* %s zakrêci³ ko³em fortuny które zatrzyma³o siê na: 5$", GetNick(playerid));
        ProxDetector(5.0, playerid, string, TEAM_GREEN_COLOR,TEAM_GREEN_COLOR,TEAM_GREEN_COLOR,TEAM_GREEN_COLOR,TEAM_GREEN_COLOR);
    }
    else if(kolo > 53 && kolo <= 57)//10
    {
        wygrana = 10;
        Log(payLog, WARNING, "%s zakrêci³ ko³em fortuny i wypad³o: 10$", GetPlayerLogName(playerid));
        format(string, sizeof(string), "* %s zakrêci³ ko³em fortuny które zatrzyma³o siê na: 10$", GetNick(playerid));
        ProxDetector(5.0, playerid, string, TEAM_GREEN_COLOR,TEAM_GREEN_COLOR,TEAM_GREEN_COLOR,TEAM_GREEN_COLOR,TEAM_GREEN_COLOR);
    }
    else if(kolo == 58 || kolo == 59)//20
    {
        wygrana = 20;
        Log(payLog, WARNING, "%s zakrêci³ ko³em fortuny i wypad³o: 20$", GetPlayerLogName(playerid));
        format(string, sizeof(string), "* %s zakrêci³ ko³em fortuny które zatrzyma³o siê na: 20$", GetNick(playerid));
        ProxDetector(5.0, playerid, string, TEAM_GREEN_COLOR,TEAM_GREEN_COLOR,TEAM_GREEN_COLOR,TEAM_GREEN_COLOR,TEAM_GREEN_COLOR);
    }
    else if(kolo == 60 || kolo == 61)//*
    {
        wygrana = 40;
        Log(payLog, WARNING, "%s zakrêci³ ko³em fortuny i wypad³o: 40$", GetPlayerLogName(playerid));
        format(string, sizeof(string), "* %s zakrêci³ ko³em fortuny które zatrzyma³o siê na gwieŸdzie fortuny (40$)", GetNick(playerid));
        ProxDetector(5.0, playerid, string, TEAM_GREEN_COLOR,TEAM_GREEN_COLOR,TEAM_GREEN_COLOR,TEAM_GREEN_COLOR,TEAM_GREEN_COLOR);
    }
