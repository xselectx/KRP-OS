...
//======================================================================
            ...
            || IsPlayerInRangeOfPoint(playerid, 3.0, 1746.2399, -1128.2211, 227.8059))
		{
            ...
            || (IsPlayerInRangeOfPoint(playerid,4,1543.3915,-1643.2813,28.4881) && IsAPolicja(playerid, 0) && GetPlayerVirtualWorld(playerid) == 29)//wiêzienie
...
//======================================================================
        ...
        {
            if(IbizaZamek) return sendTipMessageEx(playerid, 0xB52E2BFF, "Klub jest w tej chwili zamkniêty");
            if(!CheckPlayerPerm(playerid, PERM_CLUB)) return sendTipMessageEx(playerid, 0xB52E2BFF, "Nie mo¿esz têdy przejœæ, nie jesteœ z Ibiza Club!"); //RANGA
            TogglePlayerControllable(playerid, false);
...
//======================================================================
            ...
            for(new i; i<=dini_Int("Domy/NRD.ini", "NrDomow"); i++)
            {
                ...
                {
                    if(PlayerInfo[playerid][pDom] == i || Dom[i][hZamek] == 1 || PlayerInfo[playerid][pAdmin] >= 1000)
                    {
