...
new TransportJobData[][eTransportJobData] = {
    ...
    {"Artyku³y papiernicze", 	0.0, 0.0, 0.0, 						1480.9487, -1838.1323, 12.5413, 7500, 944, 4, 25},
    {"Artyku³y papiernicze", 	0.0, 0.0, 0.0, 						1279.8621, -1297.9243, 12.3369, 7500, 944, 4, 25},
    {"Alkohol", 				0.0, 0.0, 0.0, 						2449.9604, -1764.1433, 12.5697, 6000, 944, 4, 50},
    {"Czêsci samochodowe", 		0.0, 0.0, 0.0, 						2780.9678, -1618.3486, 9.9151, 6000, 944, 2, 75},
    {"Jedzenie dla zwierz¹t", 	0.0, 0.0, 0.0, 						2567.8562, -972.7701, 81.1139, 8000, 1454, 10, 100},
    {"Kawa³ki stali",			0.0, 0.0, 0.0, 						595.9616, -1296.7166, 13.8559, 5000, 944, 4, 75},
    {"Broñ", 					0.0, 0.0, 0.0, 						2153.3264, -2289.0762, 12.3670, 5000, 944, 5, 50}
};
...
{
	"Porusz siê! Za chwilê zostaniesz oznaczony jako AFK!",
	"Porusz siê. Za chwilê zostaniesz zaznaczony jako AFK!",
	"Porusz siê. Za minutê zostaniesz oznaczony AFK.",
	"Porusz siê! Za minutê oznaczymy Ciê jako AFK.",
	"Za chwilê staniesz siê AFK z powodu bezruchu.",
	"Za chwilê staniesz siê AFK z powodu bezruchu!",
	"Zbyt d³ugo stoisz w jednym miejscu. Za minutê staniesz siê AFK.",
	"Zbyt d³ugo stoisz w jednym miejscu! Za minutê staniesz siê AFK.",
	"Zbyt d³ugo stoisz w jednym miejscu. Za minutê staniesz siê AFK!",
	"Zbyt d³ugo sta³eœ w jednej pozycji. Za minutê zostaniesz oznaczony jako AFK!",
	"Zbyt d³ugo sta³eœ w jednej pozycji! Za minutê zostaniesz oznaczony jako AFK!",
	"Za d³ugo stoisz w bezruchu. Zmieñ pozycjê!",
	"Za d³ugo stoisz w bezruchu. Zmieñ pozycjê.",
	"Za d³ugo stoisz w bezruchu! Zmieñ pozycjê!",
	"Zmieñ swoj¹ pozycjê. Za d³ugo stoisz w jednym miejscu.",
	"Zmieñ swoj¹ pozycjê. Za d³ugo stoisz w jednym miejscu!",
	"Zmieñ swoj¹ pozycjê. Stoisz za d³ugo w jednym miejscu!",
	"Zmieñ swoj¹ pozycjê. Stoisz za d³ugo w jednym miejscu.",
	"Zmieñ swoj¹ pozycjê. Zbyt d³ugo stoisz w jednym miejscu.",
	"Zmieñ swoj¹ pozycjê! Zbyt d³ugo stoisz w jednym miejscu.",
	"Zmieñ swoj¹ pozycjê. Za d³ugo stoisz w jednym miejscu.",
	"Porusz siê. Za d³ugo stoisz w jednym miejscu.",
	"Porusz siê! Stoisz za d³ugo w jednym miejscu.",
	"Porusz siê, poniewa¿ za d³ugo stoisz w jednym miejscu.",
	"Stoisz za d³ugo w tym samym miejscu. Za chwilê dostaniesz status AFK.",
	"Stoisz za d³ugo w tym samym miejscu! Zmieñ pozycjê",
	"Stoisz za d³ugo w tym samym miejscu. Za chwilê dostaniesz status AFK."
};
...
ZerujZmienne(playerid)
{
	...
	PlayerPersonalization[playerid][PERS_TALKANIM] = 1; //domyœlnie wy³¹czone
	PlayerPersonalization[playerid][PERS_JOINLEAVE] = 1; //domyœlnie wy³¹czone
