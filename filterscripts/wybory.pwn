...
#define LOKAL_WYBORCZY_POS 1250.20, -1446.69, 13.55
#define LOKAL_WYBORCZY_VW 0
...
public OnFilterScriptInit()
{
	...
	pickup = CreateDynamicPickup(1239, 2, LOKAL_WYBORCZY_POS, 0);
	pickup2 = CreateDynamicPickup(1239, 2, 1253.12, -1447.33, 13.55, 0);
	pickup3 = CreateDynamicPickup(1239, 2, 1247.28, -1447.44, 13.55, 0);
...
CanPlayerVote(playerid)
{
	if(
		...
		!IsPlayerInRangeOfPoint(playerid, 20.0, LOKAL_WYBORCZY_POS)
	) {
		return 0;
	}
